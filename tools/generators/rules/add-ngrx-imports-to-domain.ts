...
import { addImportToNgModule, addImportToTsModule } from '../utils/addToNgModule';
...
function addImportAllToTsModule(tree: Tree, options: { filePath: string; importAs: string; importPath: string; }) {
